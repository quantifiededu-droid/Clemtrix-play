...
const moreLessons: Lesson[] = [
  // INTERMEDIATE (Global 9, 10) - FREE
  { id: 'int-1', title: 'Scales (C Major)', description: 'Full octave scales and finger crossing.', skillLevel: SkillLevel.INTERMEDIATE, order: 1, estimatedMinutes: 15, content: [
      { type: 'text', content: 'Scales are the building blocks of music. To play a full octave, we use the "thumb under" technique.' },
      { type: 'diagram', diagramType: 'thumbCrossing' },
      { type: 'piano', highlightedKeys: ['C4', 'D4', 'E4', 'F4', 'G4', 'A4', 'B4', 'C5'], content: 'RH Fingering: 1 2 3 (thumb under) 1 2 3 4 5' },
      { type: 'tip', content: 'Keep your wrist flexible during the thumb-under movement.' }
  ...
  { id: 'int-2', title: 'Chords & Triads', description: 'C, F, and G major triads.', skillLevel: SkillLevel.INTERMEDIATE, order: 2, estimatedMinutes: 15, content: [
      { type: 'text', content: 'A triad is a chord made of three notes. The most common are root, third, and fifth.' },
      { type: 'piano', highlightedKeys: ['C4', 'E4', 'G4'], content: 'This is a C Major chord (C-E-G).' },
      { type: 'piano', highlightedKeys: ['F4', 'A4', 'C5'], content: 'This is an F Major chord (F-A-C).' },
      { type: 'piano', highlightedKeys: ['G4', 'B4', 'D5'], content: 'This is a G Major chord (G-B-D).' }
  ...
  { id: 'int-7', title: 'Ear Training I', description: 'Identifying intervals and chord qualities.', skillLevel: SkillLevel.INTERMEDIATE, order: 7, estimatedMinutes: 15, content: [{type:'text', content: 'Connecting what you hear to what you play.'}], quizQuestions: [{id:'q1', question:'What is the goal of ear training?', options:['To play louder', 'To connect hearing to playing', 'To ignore the music', 'None'], correctAnswer:1, explanation:'Relies less on sheet music.'}, {id:'q2', question:'Which chord quality sounds "happy"?', options:['Minor', 'Major', 'Diminished', 'Augmented'], correctAnswer:1, explanation:'Major chords are generally perceived as happy.'}, {id:'q3', question:'Which chord sounds "sad"?', options:['Major', 'Minor', 'Sus4', 'None'], correctAnswer:1, explanation:'Minor chords are often described as sad.'}, {id:'q4', question:'What is an interval?', options:['A break', 'The distance between two notes', 'A type of piano', 'A finger'], correctAnswer:1, explanation:'Distance between pitches.'}, {id:'q5', question:'Does it help playing by ear?', options:['Yes', 'No', 'Only for singers', 'None'], correctAnswer:0, explanation:'It is the foundation.'}] },
  { id: 'int-8', title: 'Rhythm & Timing Mastery', description: 'Complex rhythms (triplets, ties, syncopation).', skillLevel: SkillLevel.INTERMEDIATE, order: 8, estimatedMinutes: 15, content: [{type:'text', content: 'Deep dive into triplets and syncopation.'}], quizQuestions: [{id:'q1', question:'What is syncopation?', options:['Steady beat', 'Accenting the off-beat', 'Stopping', 'Playing fast'], correctAnswer:1, explanation:'Playing off the main beat.'}, {id:'q2', question:'How many notes in a triplet beat?', options:['2', '3', '4', '1'], correctAnswer:1, explanation:'Triple means three.'}, {id:'q3', question:'What is a metronome for?', options:['Recording', 'Steady timing', 'Tuning', 'None'], correctAnswer:1, explanation:'Keeps a perfect pulse.'}, {id:'q4', question:'What is 3/4 time?', options:['4 beats', '3 beats', '12 beats', 'None'], correctAnswer:1, explanation:'3 beats per measure.'}, {id:'q5', question:'Is 6/8 different from 3/4?', options:['No', 'Yes (feel)', 'Only for drums', 'None'], correctAnswer:1, explanation:'Internal pulse grouping is different.'}] },
  { id: 'int-9', title: 'Music Theory Application', description: 'Chord construction and inversions.', skillLevel: SkillLevel.INTERMEDIATE, order: 9, estimatedMinutes: 20, content: [{type:'text', content: 'Understand why music sounds the way it does.'}], quizQuestions: [{id:'q1', question:'What is a chord inversion?', options:['New notes', 'Same notes, different order', 'Louder notes', 'None'], correctAnswer:1, explanation:'Swapping which note is on bottom.'}, {id:'q2', question:'How many major key signatures?', options:['12', '7', '5', '24'], correctAnswer:0, explanation:'One for each note in the octave.'}, {id:'q3', question:'What is a I-IV-V progression?', options:['Random numbers', 'Common harmony', 'Phone number', 'None'], correctAnswer:1, explanation:'Foundational in pop/jazz/classical.'}, {id:'q4', question:'What defines a minor chord?', options:['Major third', 'Minor third', 'Perfect fourth', 'None'], correctAnswer:1, explanation:'The third is flattened.'}, {id:'q5', question:'Why learn theory?', options:['To pass tests', 'To understand why music sounds certain ways', 'Requirement', 'None'], correctAnswer:1, explanation:'Practical mastery.'}] },
  { id: 'int-10', title: 'Intermediate Piece: Minuet in G', description: 'A classic masterwork by J.S. Bach.', skillLevel: SkillLevel.INTERMEDIATE, order: 10, estimatedMinutes: 20, content: [{type:'text', content: 'A piece that challenge technique + expression.'}], quizQuestions: [{id:'q1', question:'What is a Minuet?', options:['A fast song', 'A dance', 'A scale', 'A piano'], correctAnswer:1, explanation:'A social dance of French origin.'}, {id:'q2', question:'Which hand has the main melody?', options:['Left', 'Right', 'Both equally', 'Neither'], correctAnswer:1, explanation:'Right hand leads.'}, {id:'q3', question:'What is the time signature?', options:['4/4', '3/4', '2/4', '6/8'], correctAnswer:1, explanation:'Minuets are in 3/4.'}, {id:'q4', question:'Is the left hand simple?', options:['Yes', 'Moving bass lines', 'No notes', 'None'], correctAnswer:1, explanation:'Uses counterpoint-style movement.'}, {id:'q5', question:'Is ornamentation used?', options:['Yes (trills)', 'No', 'Only in rock', 'None'], correctAnswer:0, explanation:'Baroque pieces use trills.'}] },
  { 
    id: 'int-11', 
    title: 'Chord Playing & Accompaniment', 
    description: 'Play songs, not just written pieces.', 
    skillLevel: SkillLevel.INTERMEDIATE, 
    order: 11, 
    estimatedMinutes: 25, 
    content: [
      { type: 'text', content: '### Playing Lead Sheets\nLearn to take a basic melody and add your own chord accompaniment.\n\n- **Left-hand accompaniment patterns** (Alberti bass, broken chords)\n- **Lead sheet reading** (melody + chords)\n- **Simple improvisation** over chords' }
    ], 
    quizQuestions: [
      { id: 'q1', question: 'What is Alberti Bass?', options: ['Fast chords', 'Broken accompaniment pattern', 'A type of piano', 'A loud note'], correctAnswer: 1, explanation: 'Common in Classical era (Low-High-Middle-High).' },
      { id: 'q2', question: 'What does a Lead Sheet prioritize?', options: ['Lyrics', 'Melody and Chords', 'Finger numbers', 'None'], correctAnswer: 1, explanation: 'Gives flexibility for performance.' },
      { id: 'q3', question: 'What is "Melody vs Accompaniment balance"?', options: ['Playing everything loud', 'Making the melody sing over the chords', 'Playing everything soft', 'None'], correctAnswer: 1, explanation: 'The melody should be more prominent.' },
      { id: 'q4', question: 'How can you improvise on a melody?', options: ['Add extra notes/scales', 'Change the rhythm', 'Change the key', 'All of the above'], correctAnswer: 3, explanation: 'Many ways to vary a theme.' }
    ] 
  },
  { 
    id: 'int-12', 
    title: 'Improvisation & Creativity', 
    description: 'Develop musical freedom.', 
    skillLevel: SkillLevel.INTERMEDIATE, 
    order: 12, 
    estimatedMinutes: 20, 
    content: [
      { type: 'text', content: '### Introduction to Improvisation\nThis separates hobbyists from musicians.\n\n- **Improvising with scales**\n- **Creating simple chord progressions**\n- **Playing variations of known melodies**' }
    ],
    quizQuestions: [
      { id: 'q1', question: 'What is the "Creative" goal?', options: ['Perfecting Bach', 'Developing musical freedom', 'Learning keys', 'None'], correctAnswer: 1, explanation: 'Connecting your mind to the keys.' },
      { id: 'q2', question: 'Can anyone improvise?', options: ['Yes', 'No', 'Only geniuses', 'Only jazz players'], correctAnswer: 0, explanation: 'It is a skill that can be practiced.' }
    ]
  },
  ...
  { 
    ...
    description: 'Preparing for professional performance.', 
    skillLevel: SkillLevel.ADVANCED, 
    order: 7, 
    estimatedMinutes: 25, 
    content: [{type:'text', content: 'Techniques for mastering complex pieces.'}], 
    quizQuestions: [{id:'q1', question:'What is "slow practice"?', options:['A waste of time', 'The key to precision', 'Only for beginners', 'None'], correctAnswer:1, explanation:'Allows for neurological mapping of movements.'}] 
  },
  { 
    id: 'adv-8', 
    title: 'AI Song Master: Learn Any Song', 
    description: 'Search for any song and let our AI teach you the chords and arrangement step-by-step.', 
    skillLevel: SkillLevel.ADVANCED, 
    order: 8, 
    estimatedMinutes: 30, 
    content: [
      { type: 'text', content: '### PRO FEATURE: AI Song Learning\nYou can now learn any song in the world using our advanced AI analysis tool. Just enter a song title, and the AI will generate a customized piano tutorial for you.' },
      { type: 'exercise', steps: ['Think of your favorite song.', 'Enter it in the search box below.', 'Follow the generated chord progression and instructions.'] }
    ], 
    quizQuestions: [] 
  },
];
